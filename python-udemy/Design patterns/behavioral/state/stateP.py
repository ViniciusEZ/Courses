...
class PaymentPending(OrderState):
    def pending(self) -> None:
        print('Pagamento já pendente. Não irei realizar a ação.')
...
class PaymentApproved(OrderState):
    ...
    def approve(self) -> None:
        print('Pagamento já aprovado. Não irei realizar a ação.')
...
class PaymentRejected(OrderState):
    def pending(self) -> None:
        print('Pagamento recusado. Não irei mover para pendente.')
    
    def approve(self) -> None:
        print('Pagamento recusado. Não irei mover para aprovado.')
    
    def reject(self) -> None:
        print('Pagamento já recusado! Não irei recusar novamente.')
