...
a construção de um objeto complexo da sua representação, de modo
que o mesmo processo de construção possa criar diferentes representações.

Builder te dá a possibilidade de criar objetos passo-a-passo e isso já
é possível no Python sem este padrão.

Geralmente o builder aceita o encadeamento de processos(Method Chaining).
"""
...
if __name__ == '__main__':
    ...
    user1 = user_director.with_age('Vinicius', 'Ezequiel', 20)
    user2 = user_director.with_address('Luiz', 'Miranda', 'São Paulo')
    print(user1)
    print(user2)
