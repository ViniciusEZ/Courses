...
que tem a intenção de fornecer uma interface unificada para
um conjunto de interfaces em um subsistema.
...
class WeatherStationFacade:
    def __init__(self) -> None:
        ...
        self.smartphone = SmarthPhone('MotoG', self.weather_station)
        self.outro_smartphone = SmarthPhone('IPhone', self.weather_station)
...
if __name__ == "__main__":
    ...
    weather_station.change_state({'temperature': '33', 'humidity': '90'})
