...
class Calculator(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Calculator of Vinicius')
        ...
        self.add_btn(
            ...
            'background: #d5580d; color: #fff; font-weight: bold;'
        )
        ...
        self.add_btn(
            ...
            'background: #13823a; color: #fff; font-weight: bold;'
        )
        ...
        self.add_btn(
            QPushButton('='), 4, 4, 1, 1,
            self.eval_eq,
            'background: #095177; color: #fff; font-weight: bold;'
        )
